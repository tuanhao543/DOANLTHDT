...
public class DSDienThoai {
    ...
    { 
        ...
        System.out.println("6. Hiện ra danh sách điện thoại di động có giá nhập tối đa theo yêu cầu ( input: giá nhập)");
        System.out.println("7. Hiện ra danh sách điện thoại thông minh có giá nhập tối đa theo yêu cầu ( input: giá nhập)"); 
